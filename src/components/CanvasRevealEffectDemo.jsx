      ...
      <div className="py-20 flex flex-col  items-center justify-center">
        <div className="py-20 flex flex-col lg:flex-row items-center justify-center backdrop-blur-md dark:bg-black  w-full gap-4 mx-auto px-8 bg-white/10 rounded-md">
          <Card title="Sheetal is Nisha" icon={<AceternityIcon />}>
            <CanvasRevealEffect
              animationSpeed={5.1}
              containerClassName="bg-emerald-900 img"
            />
            {/* <Image
        src="/path-to-your-image.jpg" // Ensure the correct path to the image
        alt="Your Image Description"
        width={500} // Set the appropriate width
        height={300} // Set the appropriate height
        className="object-cover w-full h-full" // Makes the image cover the whole container
      /> */}
          </Card>
          <Card title="Xolace" icon={<AceternityIcon />}>
            <CanvasRevealEffect
              animationSpeed={3}
          ...
          <Card title="CampusHonorsHub" icon={<AceternityIcon />}>
            <CanvasRevealEffect
              animationSpeed={3}
